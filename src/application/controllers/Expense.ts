...
class ExpenseController {
    ...
    insert = async(req: Request, res: Response): Promise<void> => {
        ...
        try {
            const data = validateFields<CreateExpense>(expenseSchema, Object.assign({}, req.body, {user: req.user}))
    ...
    update = async(req: Request, res: Response): Promise<void> => {
        ...
        try {
            const data = validateFields<UpdateExpense>(expenseSchema, Object.assign({}, req.body, {user: req.user}, {id: req.params.id}))
